...
const API_URL = 'http://localhost:8088/api'; // Remplacez par l'URL de votre API
...
export const addCommande = async (commande) => {
  const response = await axios.post(`${API_URL}/commandes/add`, commande);  return response.data;
};
