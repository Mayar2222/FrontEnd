...
const Commande = () => {
  ...
  const handleAddOrder = (e) => {
    ...
    // Validation : s'assurer que tous les champs sont remplis
    if (
        ...
        <div className="w-3/4 p-6 ml-4 overflow-y-auto">
          ...
          <table className="w-full table-auto border-collapse border border-gray-300">
            ...
            <tr className="bg-gray-200">
              ...
              {/* Nouvelle colonne pour Modifier et Supprimer */}
            ...
            {orders.map((order, index) => (
                <tr key={index} className="bg-white">
                  ...
                  {/* Actions pour Voir les produits et Convertir en colis */}
                  <td className="border border-gray-300 px-4 py-2 border-l-2">
                    <div className="flex space-x-2">
                      ...
                      <button
                          ...
                          onClick={() => handleConvertToPackage(index)}
                      >
                        Convertir en colis
                      </button>
                    </div>
                      ...
                      <div className="space-y-4">
                        <label>
                          ...
                          >
                            ...
                            <option value="Produit A">Fond de teint</option>
