...
const Commande = () => {
  ...
  const fetchLocations = async () => {
    try {
      const response = await axios.get('/api/localisations'); // Remplacez par votre API GET
  ...
  const handleAddLocation = async () => {
    try {
      const response = await axios.post('/api/localisations/add', newLocation); // Remplacez par votre API POST
  ...
  const handleUpdateLocation = async (id, updatedLocation) => {
    try {
      const response = await axios.put(`/api/localisations/${id}`, updatedLocation); // Remplacez par votre API PUT
  ...
  const handleDeleteLocation = async (id) => {
    try {
      await axios.delete(`/api/localisations/${id}`); // Remplacez par votre API DELETE
