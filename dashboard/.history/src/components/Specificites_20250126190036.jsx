...
const [categories, setCategories] = useState([]);
    ...
    const fetchCategories = async () => {
        ...
        try {
            ...
            console.log("API Response:", response.data); // Vérifiez si c'est bien un tableau
    ...
    const handleAddSpecificity = async (e) => {
        ...
        console.log("Specificity Data:", specificityData); // Log pour débogage
    ...
    const handleDeleteSpecificity = async (id) => {
        console.log("Deleting specificity with ID:", id); // Log pour débogage
        try {
