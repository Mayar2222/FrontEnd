        ...
        <Menu as="div" className="relative">
          <div>
            <Menu.Button className="inline-flex items-center gap-2 rounded-md bg-gray-800 py-1.5 px-3 text-sm font-semibold text-white shadow-inner shadow-white/10 focus:outline-none hover:bg-gray-700">
              ...
              <div className='h-10 w-10 rounded-full bg-gray-500 bg-cover bg-no-repeat bg-center' style={{backgroundImage: 'url("https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?crop=faces&fit=crop&w=80&h=80&q=80")'}}>
