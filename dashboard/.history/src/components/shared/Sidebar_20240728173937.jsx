...
const linkClasses =
  'flex items-center gap-2 font-light px-32 py-2 hover:bg-neutral-700 hover:no-underline active:bg-neutral-600 rounded-sm text-base text-gray-300';
    ...
    <div className="bg-neutral-900 w-60 p-3 flex flex-col text-white h-full fixed">
      ...
      <div className="flex-1 mt-4">
        ...
        <div>
          ...
          {isGestionOpen && (
            <div className="ml-6 mt-2">
              <Link to="/commande" className={linkClasses}>
                Commande
              </Link>
              <Link to="/suivi" className={linkClasses}>
                Suivi
              </Link>
              <Link to="/facturation" className={linkClasses}>
                Facturation
              </Link>
            </div>
          )}
