    ...
    const handleAddCategory = async (e) => {
        ...
        try {
            if (isEditing) {
                ...
                const response = await axios.put(`http://localhost:8088/api/categories/${editId}`, {
                    name: newCategory,
                });
                ...
                const response = await axios.post("http://localhost:8088/api/categories/add", {
                    name: newCategory,
                });
