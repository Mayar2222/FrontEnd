...
function Specificities() {
    ...
    const handleEditSpecificity = (specificity) => {
        ...
        setSelectedCategory(specificity.category ? specificity.category.id : ""); // Vérification de category
...
<span>{specificity.specificiteName} ({specificity.category ? specificity.category.name : "Aucune catégorie"})</span>
<div>
                                    <button
