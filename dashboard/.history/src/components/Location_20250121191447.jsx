...
const MesLocalisations = () => {
    ...
    // URL de votre API
    const API_URL = 'http://localhost:8087/api/localisations';
    ...
    const handleAddLocation = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`${API_URL}/add`, newLocation);
    ...
    const handleEditLocation = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`${API_URL}/${newLocation.id}`, newLocation);
