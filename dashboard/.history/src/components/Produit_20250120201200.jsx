...
const API_URL = 'http://localhost:808/api/produits';
...
const Produit = () => {
  ...
  const categorySpecificities = {
    electronics: ['Marque', 'Modèle', 'Couleur'],
    clothing: ['Taille', 'Couleur', 'Matière'],
    homeAppliances: ['Marque', 'Puissance', 'Dimensions'],
  };
  ...
  const handleAddProduct = (e) => {
    e.preventDefault();
    if (isEditing) {
      const updatedProduct = { ...formState };
      ...
      <div className="w-3/4 p-6 ml-4 overflow-y-auto">
        ...
        <ul className="space-y-4">
          {products.map((product, index) => (
            <li key={product.id} className="p-4 bg-white shadow-lg rounded-lg">
