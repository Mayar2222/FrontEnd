...
const MesLocalisations = () => {
    ...
    const fetchLocalisations = async () => {
        try {
            const response = await axios.get('http://localhost:8088/api/localisations');
    ...
    const handleAddLocation = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:8088/api/localisations/add', newLocation);
    ...
    const handleEditLocation = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`http://localhost:8088/api/localisations/${newLocation.id}`, newLocation);
    ...
    const handleDeleteLocation = async (id) => {
        try {
            await axios.delete(`http://localhost:8088/api/localisations/${id}`);
